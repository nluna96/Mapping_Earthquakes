...
// We create the thirf tile layer that will be the background of our map.
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json(majorEarthquakesData).then(function(data) {
    ...
    function majorStyleInfo(features) {
      return {
        opacity: 1,
        fillOpacity: 1,
        fillColor: majorGetColor(features.properties.mag),
        color: "#000000",
        radius: majorGetRadius(features.properties.mag),
        stroke: true,
        weight: 0.5
      };
    }
